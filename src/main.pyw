try:
    ...
    from small_tools.small_tools_widgets import InlineCalculatorWidget, OtherToolsWidget, HotkeyGuideWidget, ChaoticPendulumWidget, KillersWidget, WindowMoverWidget
...
if __name__ == "__main__":
    ...
    with CheckStarted():
        ...
        window.add(
            ...
            WindowMoverWidget(mainwindow=window),
